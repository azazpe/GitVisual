classdef AppEvolutiva < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        loadRCCoefs
              ...
              app.Label3.Text = sprintf("Está utilizando la calibración Pixel Value");

              else 
              
              [app.D, dD] = getDoseT3_I(app.I, app.I0, maxBits);
              app.Label3.Text = sprintf("Está utilizando la calibración netOD");
              end
    ...
    t = msgbox('Dibuja una línea en la Imagen Problema para obtener el perfil de dosis. Doble click en la linea dibujada.', 'Perfil', 'help');
    pause(3.5);
    delete(t);
    ...
    app.c = improfile(app.D, pos(:,1), pos(:,2));
...
%     end
        ...
        function ApplyREButtonPushed(app, event)
            ...
            app.Label4.Text = sprintf('Está utilizando una Eficiencia Relativa de %.2f',app.RE);
        ...
        function LoadRefImageButtonPushed(app, event)
            ...
            app.I0 = imcrop(gca);
            imshow(app.I0);
            % Muestra el mensaje después de realizar el recorte
            h = msgbox("Se ha establecido imagen de referencia", "Imagen de Referencia");
            pause(1.5);
            delete(h);
            close(1);
            end
        ...
        % Reset the reference image property
         app.I0 = [];
         msgbox("Se ha reseteado la imagen de referencia, vuelva a cargarla", "Imagen de Referencia");
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            ylabel(app.UIAxes, 'Y')
            zlabel(app.UIAxes, 'Z')
            app.UIAxes.Position = [406 519 325 289];
